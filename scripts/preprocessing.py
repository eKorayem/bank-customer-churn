...
class ChurnFeatureEngineer(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        # 1. Financial Behavioral Indicators
        ...
        # 2. Demographic Risk Flags (From Phase 3 EDA)
        # Flags customers in the high-churn 40-50 age bracket
        X_new["IsHighRiskAge"] = ((X_new["Age"] >= 40) & (X_new["Age"] <= 50)).astype(int)
...
def main():
    ...
    # Ensure it writes to the correct processed data directory
    output_path = 'data/processed/dataset_bundle.pkl'
